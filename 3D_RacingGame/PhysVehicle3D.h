...
struct VehicleInfo
{
	...
	vec3 back_wheel_bar; 
	vec3 back_wheel_bar_offset; 

	vec3 suspension_front_right; 
	vec3 suspension_front_right_offset; 

	vec3 suspension_front_left;
	vec3 suspension_front_left_offset;

	vec3 suspension_back_right;
	vec3 suspension_back_right_offset;
